...
const reviews = [
   {
     ...
     username: '@thiago_Fuel2Zero',
     body: 'Desenvolver o Fuel2Zero é transformar o CO₂ em uma oportunidade, construindo um futuro com menos emissões.',
     img: 'https://github.com/Thiago.png',
   },
   {
     name: 'Fernanda (Engenheira de Processos)',
     username: '@fernanda_eng',
     body: 'O modelo da Fuel2Zero aproveita o CO₂ residual de biomassa, gerando combustível verde de forma eficiente e inovadora.',
     img: 'https://github.com/Fernanda.png',
   },
   {
     name: 'Carlos (Especialista em Sustentabilidade)',
     username: '@carlos_sustentavel',
     body: 'Conectar biomassa, Etanol e Hidrogênio Verde é o futuro da descarbonização. O Fuel2Zero está liderando essa transformação.',
     img: 'https://github.com/Carlos.png',
   },
   {
     name: 'Juliana (Consultora de Energia Verde)',
     username: '@juliana_green',
     body: 'A inovação tecnológica do Fuel2Zero torna o Metanol Verde uma realidade acessível para descarbonizar a matriz energética.',
     img: 'https://github.com/Juliana.png',
   },
   {
     name: 'Ricardo (Diretor de Operações Marítimas)',
     username: '@ricardo_maritime',
     body: 'A transição para o Metanol Verde é essencial para o transporte marítimo. A Fuel2Zero está um passo à frente.',
     img: 'https://github.com/Ricardo.png',
   },
   {
     name: 'Ana (Analista de Planejamento)',
     username: '@ana_planejamento',
     body: 'Com as ferramentas preditivas do Fuel2Zero, conseguimos planejar plantas sustentáveis e otimizadas.',
     img: 'https://github.com/Ana.png',
   },
   {
     name: 'Marcos (Especialista em Biomassa)',
     username: '@marcos_biomassa',
     body: 'Integrar CO₂ de biomassa em um modelo de produção eficiente é uma solução única que só o Fuel2Zero oferece.',
     img: 'https://github.com/Marcos.png',
   },
   {
     name: 'Carolina (Engenheira de Projetos)',
     username: '@carolina_proj',
     body: 'A precisão das análises do Fuel2Zero garante decisões estratégicas para viabilizar plantas conectadas.',
     img: 'https://github.com/Carolina.png',
   },
   {
     name: 'Pedro (Especialista em Hidrogênio Verde)',
     username: '@pedro_h2green',
     body: 'O Fuel2Zero é um marco na produção de Hidrogênio Verde, unindo eficiência e sustentabilidade.',
     img: 'https://github.com/Pedro.png',
   },
   {
     name: 'Mariana (Head de Estratégia)',
     username: '@mariana_strategy',
     body: 'Decisões estratégicas para descarbonização começam com o Fuel2Zero. O impacto vai além das emissões.',
     img: 'https://github.com/Mariana.png',
   },
   {
     name: 'Luiz (Diretor de Energia)',
     username: '@luiz_energy',
     body: 'O modelo Fuel2Zero reduz custos e acelera a transição para combustíveis sustentáveis como o Metanol Verde.',
